...
<%@taglib prefix="shirofn" uri="http://www.toceansoft.com/tags/shiro-functions" %>
<html>
<head>
    <title></title>
...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${shirofn:resourceNames(role.resourceIds)}" readonly>
    ...
    <script>
        $(function () {
            ...
            var zNodes =[
                ...
                { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${shirofn:in(role.resourceIds, r.id)}},
                </c:if>
                </c:forEach>
            ];
